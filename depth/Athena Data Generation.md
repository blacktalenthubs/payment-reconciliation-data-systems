```python
"""
This Python code creates complex data schemas and write data to S3,we can then built athena tables on top on these data 
to allow you practice for complex struct,map, and arrays in schemas 
"""
